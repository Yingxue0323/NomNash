...
interface BusinessProfile { // Business Profile object containing all relevant variables 
  name: string;
  email: string;
  role: string;
  password: string;
...
export class BusinessProfileComponent {
  ...
  businessProfile: BusinessProfile = { // Object holding business profile details, all initialised with default values
    name: 'John Doe',
  ...
  saveChanges(): void { // Save changes function
    ...
    console.log('Profile updated:', this.businessProfile);
  }
}